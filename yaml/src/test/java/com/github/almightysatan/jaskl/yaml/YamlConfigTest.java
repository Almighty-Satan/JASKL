...
public class YamlConfigTest {
    ...
    public void testLoadSimple() throws IOException {
        Config config = YamlConfig.of(new File("src/test/resources/basic.yaml"), null);
    ...
    public void testLoadSingleValue() throws IOException {
        Config config2 = YamlConfig.of(new File("src/test/resources/singleValue.yaml"), null);
    ...
    public void testLoadComplex() throws IOException {
        Config config = YamlConfig.of(new File("src/test/resources/complex.yaml"), null);
    ...
    public void testLoadNonExisting() throws IOException {
        Config config = YamlConfig.of(new File("src/test/resources/simple.yaml"), null);
    ...
    public void testWriteFile() throws IOException {
        ...
        Config config1 = YamlConfig.of(file, null);
        ConfigEntry<String> stringConfigEntry1 = StringConfigEntry.of(config1, "abc.exampleString", "This is a test", "default");
        ConfigEntry<Integer> intConfigEntry1 = IntegerConfigEntry.of(config1, "abc.exampleInt", "This is another test", 69);
    ...
    public void testStripFile() throws IOException {
        File file = new File("build/temp/yaml/strip.yaml");
        file.delete();
        ...
        Config config2 = YamlConfig.of(file, null);
