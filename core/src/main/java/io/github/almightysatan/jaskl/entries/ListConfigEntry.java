...
public interface ListConfigEntry<T> extends ConfigEntry<List<T>> {
    ...
    @SafeVarargs
    static <T> ListConfigEntry<T> of(@NotNull Config config, @NotNull String path, @Nullable String description, @NotNull List<T> defaultValue, @NotNull Type<T> type, @NotNull Validator<List<T>>... validators) throws InvalidTypeException, ValidationException {
