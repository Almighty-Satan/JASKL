...
public interface EnumConfigEntry<T extends Enum<T>> extends ConfigEntry<T> {
    ...
    static <T extends Enum<T>> ConfigEntry<T> of(@NotNull Config config, @NotNull String path, @Nullable String description, T defaultValue, @NotNull Validator<T>... validators) {
