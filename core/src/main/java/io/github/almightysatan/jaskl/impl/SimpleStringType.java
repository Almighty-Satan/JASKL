...
@FunctionalInterface
public interface SimpleStringType<T> extends Type<T> {
    ...
    static <T> SimpleStringType<T> of(@NotNull Class<T> clazz, @NotNull Function<@NotNull String, @NotNull T> parser) {
        ...
        return value -> {
            ...
            throw new InvalidTypeException(clazz, value.getClass());
        };
    }
}
